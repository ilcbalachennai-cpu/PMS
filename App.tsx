...
const PayrollShell: React.FC<{ onRefresh: () => void }> = ({ onRefresh }) => {
  ...
  const {
    ...
    arrearHistory, setArrearHistory, designations, setDesignations, divisions, setDivisions,
  ...
  const {
    settingsTab, setSettingsTab, isSidebarOpen,
  ...
  return (
    <div className="flex h-[100dvh] overflow-hidden bg-[#020617] text-white">
      <CustomModal {...alertConfig} onClose={closeAlert} />
