...
const PayrollShell: React.FC<{ onRefresh: () => void }> = ({ onRefresh }) => {
  ...
  useEffect(() => {
    ...
    syncToDB();
  }, [employees, config, companyProfile, attendances, leaveLedgers, advanceLedgers, payrollHistory, fines, leavePolicy, arrearHistory, logoUrl]);
  ...
  const handleRegistrationComplete = (data: {
    ...
    // Add or Update admin
    const adminIdx = savedUsers.findIndex(u => u.username === 'admin');
    if (adminIdx >= 0) {
