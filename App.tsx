    ...
    <div className="flex h-[100dvh] overflow-hidden bg-[#020617] text-white">
      ...
      <main ref={mainContentRef} className="flex-1 overflow-y-auto">
        ...
        <div className="p-8 max-w-7xl mx-auto">
          ...
          {activeView === View.Employees && <EmployeeList employees={employees} setEmployees={setEmployees} onAddEmployee={handleAddEmployee} designations={designations} divisions={divisions} branches={branches} sites={sites} currentUser={currentUser} />}
