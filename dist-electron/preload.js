...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    hardResetApp: () => electron_1.ipcRenderer.invoke('hard-reset-app'),
    closeUpdateMessage: () => electron_1.ipcRenderer.invoke('close-update-message'),
    ...
    onUpdateCloseWarning: (callback) => {
        electron_1.ipcRenderer.removeAllListeners('update-close-warning');
        electron_1.ipcRenderer.on('update-close-warning', () => callback());
    },
    ...
    getActivatedSilos: () => electron_1.ipcRenderer.invoke('get-activated-silos'),
    registerActivatedSilo: (signature) => electron_1.ipcRenderer.invoke('register-activated-silo', signature),
    ...
    generateDiagnostics: (uiState) => electron_1.ipcRenderer.invoke('generate-diagnostics', uiState)
});
