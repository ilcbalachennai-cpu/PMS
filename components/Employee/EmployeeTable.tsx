                    ...
                    {employees.map((emp) => (
                        ...
                        >
                            ...
                            <td className="px-2 py-2.5 text-right">
                                <div className="font-mono text-emerald-400 font-black text-[12px] tracking-tighter shadow-emerald-400/10 whitespace-nowrap">₹ {formatIndianNumber(calculateGrossWage(emp))}</div>
                            </td>
