...
import { Plus, Trash2, Save, Building, MapPin, Briefcase, Network, Search, X } from 'lucide-react';
...
const MasterManager: React.FC<MasterManagerProps> = ({ title, items, setItems, icon: Icon }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <MasterManager title="Designation Master" items={props.designations} setItems={props.setDesignations} icon={Briefcase} />
        <MasterManager title="Division Master" items={props.divisions} setItems={props.setDivisions} icon={Network} />
        <MasterManager title="Branch Master" items={props.branches} setItems={props.setBranches} icon={Building} />
        <MasterManager title="Site Master" items={props.sites} setItems={props.setSites} icon={MapPin} />
      </div>
    </div>
  );
};
