    ...
    const handleClearData = () => {
        ...
        if (viewMode === 'advance') {
            setModalState({
                isOpen: true,
                type: 'confirm',
                title: 'Clear Advance Data',
                message: 'Are you sure you want to clear all Advance Ledger entries? This will set all advance balances to zero for the current period.',
                onConfirm: () => {
                    setAdvanceLedgers([]);
