...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getActivatedSilos: (isDevMode?: boolean) => ipcRenderer.invoke('get-activated-silos', isDevMode),
    registerActivatedSilo: (signature: string, isDevMode?: boolean) => ipcRenderer.invoke('register-activated-silo', signature, isDevMode),
    removeActivatedSilo: (signature: string, isDevMode?: boolean) => ipcRenderer.invoke('remove-activated-silo', signature, isDevMode),
    syncActivatedSilos: (validCloudSigs: string[]) => ipcRenderer.invoke('sync-activated-silos', validCloudSigs),
    wipeActivatedSilos: () => ipcRenderer.invoke('wipe-activated-silos'),
    wipeAllLocalSignatures: (isDevMode?: boolean) => ipcRenderer.invoke('wipe-all-local-signatures', isDevMode),
    purgeUnmatchedLocalSignatures: (validCloudSignatures: string[], isDevMode?: boolean) => ipcRenderer.invoke('purge-unmatched-local-signatures', validCloudSignatures, isDevMode),
