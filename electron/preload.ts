...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getActivatedSilos: () => ipcRenderer.invoke('get-activated-silos'),
    ...
    purgeUnmatchedLocalSignatures: (validCloudSignatures: string[]) => ipcRenderer.invoke('purge-unmatched-local-signatures', validCloudSignatures),
